...
class RestAreaReminder110 extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(RestArea $restArea, CheckIn $checkIn)
    {
        ...
        $this->delay($checkIn->in->addMinutes(110));
    }
    ...
    public function toFcm($notifiable)
    {
        return (new PushMessage())
            ->title("[REST AREA] Waktu anda parkir sudah 110 menit")
            ->body("10 menit lagi waktumu akan habis, yuk bergegas karna semua orang ingin istirahat.");
    }
