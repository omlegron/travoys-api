...
class RestAreaReminder30 extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(RestArea $restArea, CheckIn $checkIn)
    {
        ...
        $this->delay($checkIn->in->addMinutes(30));
    }
    ...
    public function toFcm($notifiable)
    {
        return (new PushMessage())
            ->title("[REST AREA] Waktu anda parkir sudah 30 menit")
