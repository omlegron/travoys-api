...
class RestAreaReminder100 extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(RestArea $restArea, CheckIn $checkIn)
    {
        ...
        $this->delay($checkIn->in->addMinutes(100));
    }
    ...
    public function toFcm($notifiable)
    {
        return (new PushMessage())
            ->title("[REST AREA] Waktu anda parkir sudah 100 menit")
            ->body("Tinggal 20 menit terakhir nih, udah siap belum?");
    }
