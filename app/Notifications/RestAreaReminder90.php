...
class RestAreaReminder90 extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(RestArea $restArea, CheckIn $checkIn)
    {
        ...
        $this->delay($checkIn->in->addMinutes(90));
    }
    ...
    public function toFcm($notifiable)
    {
        return (new PushMessage())
            ->title("[REST AREA] Waktu anda parkir sudah 90 menit")
            ->body("Yah waktumu udah tinggal 30 menit terakhir nih, yuk kita siap-siap jalan lagi!");
    }
